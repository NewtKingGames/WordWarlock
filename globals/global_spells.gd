...
var ice_themed_words: Array[String] = ["ICE", "FROST", "CHILL", "SNOW", "COLD", "HAIL", "GLACIER", "CRYSTAL", "SLUSH", "RIME", "FROSTBITE", "SHIVER", "BLIZZARD", "FRIGID", "FREEZE", "HAILSTORM", "ICICLE", "FROSTY", "HOARFROST", "SHIVERING", "GLACIAL", "ICEBERG", "TUNDRA", "SNOWFLAKE", "FROSTING", "FROSTBITE", "SLEET", "RIMEFROST", "COLDSNAP", "SNOWSTORM", "BREEZE", "GLACIAL", "HAILSTONE", "FROSTFALL", "ICY", "WINTER", "SNOWDRIFT", "HARDEN", "FROSTWEAVE", "SHIVER", "ICEWALL", "FREEZE", "RIME"]
